...
// 通过查找PspCreateProcessNotifyRoutine PspLoadImageNotifyRoutine PspCreateThreadNotifyRoutine 
// 特征码定位  win7 x64是下面的特征;可能高版本系统特征改变
// 注意下面全部没有加锁;正式的产品需要加锁访问
...
UINT64 FindPspCreateProcessNotifyRoutine()
{
	...
	char Pattern2[3] = { 0x4C,0x8D,0x35 };
...
{
	UINT64 PspCreateProcessFunc = FindPspCreateProcessNotifyRoutine(), pRoutineAddress;
